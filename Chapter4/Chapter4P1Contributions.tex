...
\begin{enumerate}
	...
	%Additionally, as a result of this study, I provide a generalised software framework for an ideal \ac{mri} simulator that can serve as a guideline for the \ac{mri} simulation community worldwide (Chapter \ref{chapterlabel4sec2}).
