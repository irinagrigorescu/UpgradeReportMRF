...
Moreover, by adding tissue or system imperfection to the model, the complexity of the simulation increases even further.
...
There is a need to have a realistic \ac{mri} simulation framework to accurately and precisely investigate the nature of commonly occurring \ac{mri} artefacts.
...
\begin{enumerate}
    ...
    However, most MR simulators rely on \ac{cpu} based parallelisation techniques.
...
Moreover, I aim to use this \ac{mri} simulator to investigate the impact of motion in a novel quantitative \ac{mri} protocol known as Magnetic Resonance Fingerprinting.
