...
%Table~\ref{table:tableMRISimulatorsLimitations} presents their key limitations and 
while the following paragraphs delve into the details of each simulator.

\hfill

% % % 
% % % Table~\ref{table:tableMRISimulatorsFeatures}
% % % 
\begin{table}[h!]
\centering
 \begin{tabular}{||c | c c c c c ||} 
 \hline
 General Features & \textbf{P} & \textbf{J} & \textbf{O} & \textbf{ML} & \textbf{S} \\ [0.5ex] 
 \hline\hline
 % % %
 \begin{tabular}{@{}c@{}c@{}c@{}}\textbf{Operating System}\\Linux\\Windows\\Mac OS\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} \\
 \hline
 % % %
 \begin{tabular}{@{}c@{}c@{}c@{}}\textbf{Programming Language}\\C\phantom{++}\\C++\\MATLAB\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\phantom{-}\\\phantom{-}\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\phantom{-}\\\phantom{-}\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\phantom{-}\\\phantom{-}\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\phantom{-}\\\phantom{-}\\$\checkmark$\\$\checkmark$\end{tabular} & 
 \begin{tabular}{@{}c@{}c@{}c@{}}\phantom{-}\\$\checkmark$\\\phantom{-}\\\phantom{-}\end{tabular} \\
 \hline
 % % %
%  \textbf{Open-Source} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ \\
%  \hline
 % % %
 ...
 \hline
 % % % 
 \begin{tabular}{@{}c@{}c@{}c@{}}\textbf{Solver Type}\\Bloch\\Bloch-Torrey\\Bloch-McConnell\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\\\phantom{-}\end{tabular} \\
 \hline
  % % % 
 \begin{tabular}{@{}c@{}c@{}c@{}}\textbf{Solver Approach}\\Analytical\\Numerical\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\\phantom{-}\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\end{tabular}  \\
 \hline
 % % %
 \begin{tabular}{@{}c@{}c@{}}\textbf{Multi-RF}\\Receiving\\Transmitting\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\end{tabular} & 
 \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\\phantom{-}\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\end{tabular}  \\
 \hline
 % % %
 \textbf{Motion} & $\checkmark$ & $\checkmark$ & \phantom{-} & $\checkmark$ & \phantom{-} \\
 \hline
 % % %
 \begin{tabular}{@{}c@{}}\textbf{Sequence Design}\\\textbf{GUI}\end{tabular} & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \phantom{-} \\
 \hline
 % % %
 \begin{tabular}{@{}c@{}}\textbf{Coil Design}\\\textbf{GUI}\end{tabular} & \phantom{-} & $\checkmark$ & \phantom{-} & $\checkmark$ & \phantom{-} \\
 \hline
 % % %
 \begin{tabular}{@{}c@{}}\textbf{K-space Trajectory}\\\textbf{Visualisation}\end{tabular} & \phantom{-} & $\checkmark$ & $\checkmark$ & $\checkmark$ & \phantom{-} \\
 \hline
 % % %
...
%  \hline
 ...
 \hline
  % % %
 \textbf{Last Update} & Nov'17 & Mar'18 & Nov'16 & Jul'17 & Jun'07 \\
 \hline
\end{tabular}
\caption{Summary of features of the current active MRI simulators, where \textbf{P} - POSSUM, \textbf{J} - JEMRIS, \textbf{O} - ODIN, \textbf{ML} - MRiLab, \textbf{S} - SIMRI}
\label{table:tableMRISimulatorsFeatures}
\end{table}

\hfill

% % % 
% % % Table~\ref{table:tableMRISimulatorsLimitations}
% % % 
% \begin{table}[h!]
% \centering
%  \begin{tabular}{||c | c c c c c ||} 
%  \hline
%  Desirable Features & \textbf{P} & \textbf{J} & \textbf{O} & \textbf{ML} & \textbf{S} \\ [0.5ex] 
%  \hline\hline
%   % % %
%  \begin{tabular}{c@{}} \textbf{Relaxation during} \\ \textbf{RF Pulses} \end{tabular} & 
%  \begin{tabular}{c@{}}$N/A$\end{tabular} & \begin{tabular}{c@{}}$\checkmark$\end{tabular} & \begin{tabular}{c@{}}$N/A$\end{tabular} & \begin{tabular}{c@{}}$N/A$\end{tabular} & \begin{tabular}{c@{}}$N/A$\end{tabular} \\
%  \hline
%  % % %
%  \begin{tabular}{@{}c@{}c@{}c@{}}\textbf{Operating System}\\Linux\\Windows\\Mac OS\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} & \begin{tabular}{@{}c@{}c@{}c@{}}\\$\checkmark$\\$\checkmark$\\$\checkmark$\end{tabular} \\
%  \hline
...
% \end{tabular}
% \caption{Summary of key limitations of the current active MRI simulators, where \textbf{P} - POSSUM, \textbf{J} - JEMRIS, \textbf{O} - ODIN, \textbf{ML} - MRiLab, \textbf{S} - SIMRI}
% \label{table:tableMRISimulatorsLimitations}
% \end{table}
...
\begin{itemize}
    ...
    % \item \textbf{Relaxation during the application of RF pulses is not modelled}.
    % ODIN models RF pulses as instantaneous rotations through an angle, while shaped RF pulses are modelled as sequences of hard pulses (instantaneous rotations of the isochromat ensemble) \cite{bernsteinhandbook}.
    ...
    % This is because in this framework dephasing across a voxel is considered, but it does not create a distribution of spins to be flipped by following RF pulses and to form stimulated echoes.
    % Moreover, the experiments shown in \cite{Jochimsen2006} had repetition periods of $5$s, which is greater than the $T_2$ values used in their experiments.
...
\begin{itemize}
    ...
    %is based on discrete time analytical solutions of the Bloch or Bloch-McConnell equations which means that it cannot do etc
    ...
    % Moreover, the simulation of gradient spoiling in MRILAB may reach 
...
\begin{itemize}
    ...
    % \item It is one of the first MRI simulators based on a discrete-event Bloch equation resolution who used parallelisation techniques to achieve realistic computational times and performances.
    ...
    %; $\tau$ is set to 0 when it first encounters an excitation pulse, it is then set to $t$ after the excitation 
...
\begin{itemize}
    ...
    %\item \textbf{$B_0$ inhomogeneities}: Inhomogeneities in the main magnetic field can be added 
...
These five simulators use different approaches in terms of simulation strategy.
More specifically, 
