...
\begin{itemize}
    ...
    %has successfully shown linear intra-voxel dephasing due to field perturbations.
    %However, the simulated sequences had repetition periods of $5$s.
    %It is therefore \textbf{not} yet \textbf{proven that their implementation can account for appropriate rephasing of the magnetisation vectors in fast multi-pulse sequences}, where the typical $T_R$ values are much smaller than the transverse relaxation times.
